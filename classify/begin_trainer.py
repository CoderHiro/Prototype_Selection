...
if __name__ == "__main__":
    ...
    if dataset == 'BIG15':
        ...
        data_path = '/data/cgh/new-14-family/'

    if selected_level == 'random':
        selected_path = '/home/cgh/prototype_selection/select/MMD-critic-master/selected_{}/{}_{}_{}.csv'.format(selected_rate, dataset, selected_level, random_seed)
    elif selected_level == 'all':
        selected_path = '/home/cgh/prototype_selection/LBP/output/{}_selected_name_list.csv'.format(dataset)
    else:
        selected_path = '/home/cgh/prototype_selection/select/MMD-critic-master/selected_{}/{}_{}_{}.csv'.format(selected_rate, dataset, selected_level, scale)    
    ...
    save_parameters = './model_{}/new_{}_{}_{}.h5'.format(selected_rate, dataset, model_type, selected_level)
    save_image = './results_{}/new_{}_{}_{}_hist.eps'.format(selected_rate, dataset, model_type, selected_level)
    ...
    with open('./results_{}/new_{}_{}.txt'.format(selected_rate, model_type, selected_level), 'w') as f:
